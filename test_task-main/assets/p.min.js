...
jQuery(document).ready(function () {
  ...
  $(document).ready(function () {
    $(".bq1").click(function () {
      responses.length = 0;
      responses.push({
        question: $("#q1 .question span").text().trim(),
        answer: this.textContent.trim(),
      });
      ...
      $(".bq2").click(function () {
        responses.push({
          question: $("#q2 .question span").text().trim(),
          answer: this.textContent.trim(),
        });
      ...
      $(".bq3").click(function () {
        responses.push({
          question: $("#q3 .question span").text().trim(),
          answer: this.textContent.trim(),
        });
      ...
      $(".bq4").click(function () {
        responses.push({
          question: $("#q4 .question span").text().trim(),
          answer: this.textContent.trim(),
        });
        scrollTo("id1"),
